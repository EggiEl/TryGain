...
export default function Beitrag({ bild_url, heading, caption , smallheading}: BeitragProps) {
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "51.6%", backgroundColor: "rgba(255, 255, 255, 1)" }}>
      <div style={{ position: "relative", left: "21%", top: "2.8%", marginBottom: "2.8%", color: '#0D276B', fontSize: "1.7svh", fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>
        {heading}
      </div>
