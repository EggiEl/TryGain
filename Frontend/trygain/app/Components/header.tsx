...
export default function Header() {
  return (
    <div id="Hintergrund Container" style={{ position: "fixed", width: '100%', height: '10.5svh', background: 'rgba(244, 246, 252, 1)', zIndex: "10" }}>
      <div id="PositionofIcons" style={{ position: "absolute", left: "80%", top: "50%" }}>
